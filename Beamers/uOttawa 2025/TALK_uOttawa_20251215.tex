...
%\centering
%\begin{tikzpicture}
	\startchronology[startyear=2016, stopyear=2025, height=5em, color=MacMaroon]
	\chronoperiode[color=SFURed]{2016}{2018}{MSc in Applied Mathematics, Simon Fraser University}
	\chronoperiode[color=UnigeGreen]{2018}{2022}{PhD in Applied Mathematics, University of Geneva}
	\chronoperiode[color=uLavalGold]{2022}{2024}{CRM-uLaval PDF, Universit\'e Laval}
	\chronoperiode[color=MacMaroon]{2024}{2025}{PDF, McMaster University}
	\stopchronology
%\end{tikzpicture}
%\end{figure}
\end{frame}
...
\begin{tikzpicture}
%bachelor
\draw [line width=1mm] (0.3, 0.4) -- (0, 0) -- (2.2, 0) -- (2.5, 0.4) -- (2.2, 0.8) -- (0, 0.8) -- (0.3, 0.4);
\fill [purple!50] (0, 0) -- (2.2, 0) -- (2.5, 0.4) -- (2.2, 0.8) -- (0, 0.8) -- (0.3, 0.4) -- (0, 0);
\node at (1.3, 0.4) {\bf 2013 -- 2016};
\node at (1.3, 2.7) [thick, rectangle, draw, align = left] 
{BSc. in Mathematics};
\draw [thick] (1.3, 0.8) -- (1.3, 1.8);
%master
\draw [line width=1mm] (2.8, 0.4) -- (2.5, 0) -- (4.9, 0) -- (5.2, 0.4) -- (4.9, 0.8) -- (2.5, 0.8) -- (2.8, 0.4);
\fill [purple!50] (2.5, 0) -- (4.9, 0) -- (5.2, 0.4) -- (4.9, 0.8) -- (2.5, 0.8) -- (2.8, 0.4) -- (2.5, 0);
\node at (3.9, 0.4) {\bf 2016 - 2018};
\node at (3.5, -1.7) [thick, rectangle, draw, align = left] 
{MSc. in Mathematics \\
of modelling};
\draw [thick] (4.7, 0) -- (4.7, -1.05);
%PhD
\draw [line width=1mm] (5.5, 0.4) -- (5.2, 0) -- (8.2, 0) -- (8.5, 0.4) -- (8.2, 0.8) -- (5.2, 0.8) -- (5.5, 0.4);
\fill [purple!50] (5.2, 0) -- (8.2, 0) -- (8.5, 0.4) -- (8.2, 0.8) -- (5.2, 0.8) -- (5.5, 0.4) -- (5.2, 0);
\node at (6.8, 0.4) {\bf 2018 -- 2021};
\node at (6.8, 2.7) [thick, rectangle, draw, align = left] 
{PhD in {\bf Microalgae }\\
{\bf modelling and}\\
{\bf optimization}};
\draw [thick] (6.1, 0.8) -- (6.1, 1.85);
\node at (7, -1.7) [thick, rectangle, draw, align = left] 
{Research stay in\\
02/2020 -- 04/2021};
\draw [thick] (7.7, 0) -- (7.7, -1);
%unige
\draw [line width=1mm] (8.8, 0.4) -- (8.5, 0) -- (11.5, 0) -- (11.8, 0.4) -- (11.5, 0.8) -- (8.5, 0.8) -- (8.8, 0.4);
\fill [purple!50] (8.5, 0) -- (11.5, 0) -- (11.8, 0.4) -- (11.5, 0.8) -- (8.5, 0.8) -- (8.8, 0.4) -- (8.5, 0);
\node at (10.1, 0.4) {\bf 2021 -- 2025};
\node at (10.5, -1.7) [thick, rectangle, draw, align = left] 
{Postdoc in {\bf Parallel}\\
{\bf computing for PDEs}};
\draw [thick] (11.2, 0) -- (11.2, -1.05);
%\draw [thick] (8.9, -1.9) -- (12.1, -1.9);
%lund
\draw [line width=1mm] (12.1, 0.4) -- (11.8, 0) -- (13.5, 0) -- (13.8, 0.4) -- (13.5, 0.8) -- (11.8, 0.8) -- (12.1, 0.4);
\fill [purple!50] (11.8, 0) -- (13.5, 0) -- (13.8, 0.4) -- (13.5, 0.8) -- (11.8, 0.8) -- (12.1, 0.4) -- (11.8, 0);
\node at (12.7, 0.4) {\bf 2025 -- };
\node at (12.5, 2.7) [thick, rectangle, draw, align = left] 
{Postdoc in {\bf Coupling} \\
{\bf problems for climate} \\
{\bf model}};
\draw [thick] (12.1, 0.8) -- (12.1, 1.85);
\end{tikzpicture}
