...
%				
%				\coordinate (B1) at (-1.1,-0.1);
%				\coordinate (B2) at (0,0.1);
%				\coordinate (B3) at (-0.5,0.9);
%				
%				\draw[blue] (B1)--(B2)--(B3)--cycle;
%				\draw[red] (R1)--(R2)--(R3)--cycle;
%				\filldraw[blue] (B2) circle (1pt);
%				\filldraw[blue] (B3) circle (1pt);
%			\end{tikzpicture}
%			\caption{Blue vertices in red triangle}
%		\end{figure}
%	\end{frame}
%	\begin{frame}
%	\begin{figure}
...
%		\draw[red] (R1)--(R2)--(R3)--cycle;
%		\end{tikzpicture}
%		\caption{Red vertices in blue triangle}
%	\end{figure}
%	\end{frame}
%	\begin{frame}
%	\begin{figure}
...
%
%		\draw[purple] (B2)--(B3);
%			\filldraw[purple] (B2) circle (1pt);
%			\filldraw[purple] (B3) circle (1pt);
%		\end{tikzpicture}
%		\caption{Final result - no intersection!}
%	\end{figure}
%	\end{frame}
