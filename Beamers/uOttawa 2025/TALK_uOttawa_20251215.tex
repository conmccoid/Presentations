...
\begin{tikzpicture}[every text node part/.style={align=left}]
	...
	\draw (1*\yearlength,0.25) -- (1*\yearlength,-1);
	\draw (5.5*\yearlength,0.5) -- (5*\yearlength,1.5);
	\draw (7*\yearlength,0.25) -- (6*\yearlength,-2.5);
	\draw (11*\yearlength,0.75) -- (11*\yearlength,2.5);
	\draw (13*\yearlength,0.75) -- (11.5*\yearlength,2);
	\draw (15*\yearlength,0.25) -- (16*\yearlength,-1);
	\filldraw[fill=SFURed] (1*\yearlength,-1) circle (3pt) node[fill=SFURed!50, right, draw] {\textbf{Mathematical Physics} \\ SFU};
	\filldraw (5*\yearlength,1.5) circle (3pt) node[fill=SFURed!50, left, draw] {\textbf{USRA} \\ SFU};
	\filldraw[fill=SFURed] (6*\yearlength,-2.5) circle (3pt) node[fill=SFURed!50, right, draw] {\textbf{Applied Mathematics} \\ \textit{Pseudospectral methods} \\ SFU};
